...
- Put your token in `src/financial_claw/ocr/mineru/.env` (ignored by git) as `MINERU_API_TOKEN=...`
...
python -m financial_claw.ocr.mineru.extract_table_from_image --image path/to/img.png --mode precision

# Extract tables directly into xlsx
python -m financial_claw.ocr.mineru.extract_table_image_to_excel --image path/to/img.png --mode precision --out-xlsx out.xlsx
```
